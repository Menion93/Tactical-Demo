...
void ATacticalGamePlayerController::PlayerTick(float DeltaTime)
{
...
void ATacticalGamePlayerController::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void ATacticalGamePlayerController::MoveToMouseCursor()
{
	//if (UHeadMountedDisplayFunctionLibrary::IsHeadMountedDisplayEnabled())
	//{
	//	if (ATacticalGameCharacter* MyPawn = Cast<ATacticalGameCharacter>(GetPawn()))
	//	{
...
void ATacticalGamePlayerController::MoveToTouchLocation(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void ATacticalGamePlayerController::SetNewMoveDestination(const FVector DestLocation)
{
...
void ATacticalGamePlayerController::OnSetDestinationPressed()
{
